...
namespace InvoiceApi.Constants
{
    public static class SqlQuery
    {
        ...
        public const string SaveInvoiceDetails = @"INSERT INTO tbl_Invoice_Details (User_Id, Invoice_No,Invoice_Date,Due_Date,Business_Id,Client_Id,Notes,Terms,Tax,Discount,Total,SubTotal,Taxtype,DiscountType,Template_Name,TaxPercentage,DiscountPercentage,IsCustomDate,IsCustomDueDate,Custom_Date,Custom_DueDate,currency_code,taxlabel,DiscountLabel) OUTPUT INSERTED.Invoice_Id  VALUES(@UserId,@InvoiceNumber,@InvoiceDate,@InvoiceDueDate,@BusinessId,@ClientId,@Notes,@Terms,@Tax,@Discount,@Total,@SubTotal,@Taxtype,@DiscountType,@TemplateName,@TaxPercentage,@DiscountPercentage,@IsCustomDate,@IsCustomDueDate,@CustomDate,@CustomDueDate,@CurrencyCode,@TaxLabel,@DiscountLabel)";
